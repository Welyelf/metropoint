                    ...
                    <div class="col-md-12">
                        <form class="form-horizontal" role="form" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-10">
                                    <textarea id="description" name="description" class="form-control" maxlength="225" rows="2"><?= $engine_details->description; ?></textarea>
                                </div>
                            </div>
                            <div class="modal-footer modal-footer-detail">
                                <div class="button-modal-list">
                                    <a href="<?= base_url('admin/engine/') ?>" id="demo-btn-addrow" class="btn btn-danger m-b-20 text-right"><i class="fa fa-remove m-r-5"></i> Cancel</a>
